...
class ProgressService
{
    ...
    public function learningPath(string $userId): array
    {
        ...
        $weeklyPlan = $skills->map(function (UserProgress $p) {
            $gap = $p->target_level
            ...
            return [
                ...
                'focus_area' => null,
                'recommended_level' => $this->recommendedLevel($p),
    ...
    private function recommendedLevel(UserProgress $p): Level
    {
        if ($p->scaffold_level >= self::SCAFFOLD_PER_LEVEL) {
